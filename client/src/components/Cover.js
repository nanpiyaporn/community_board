...
return (
  <div className="h-36 overflow-hidden flex justify-center item-center relative"> 
  <div>
    <img src = {url} alt = " " className = "w-full h-full object-cover"/>
  </div>
  
    {isUploading && (
    <div className = "absolute inset-0 bg-white bg-opacity-80 flex item-center z-10 " >
