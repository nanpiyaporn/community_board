...
return (
  <div className={'${width} relative'}> 
    ...
    {isUploading && <div className = "absolute inset-0 flex-center bg-white bg-opacity-50 rounded-full " >
      ...
      {editable && (
        <label className = "absolute bottom-)0 right-0 shadow-gray-500 p-2 bg-white rounded-full cursor-pointer" >
